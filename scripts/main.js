      ...
      class VikarovCraftingWindow extends Application {
        ...
        static get defaultOptions() {
          return foundry.utils.mergeObject(super.defaultOptions, {
            ...
            width: 500,
            height: 500, // Increased height for additional UI elements
            resizable: true
          });
        }
        ...
        getData() {
          const data = {
            actor: this.actor,
            reagent0: this.reagents[0], // Provide individual properties instead of array
            reagent1: this.reagents[1],
            reagent2: this.reagents[2]
          };
